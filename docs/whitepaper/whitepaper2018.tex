...
\newblock {TensorFlow: A sytem for large-scale machine learning}.
\newblock In \emph{{Proceedings of the 12th USENIX Symposium on Operating
  Systems Design}}, pages 265--283, Savannah, GA, USA, 2016.

\bibitem[Andrew et~al.(2009)Andrew, Br{\"{u}}derle, Eppler, Kremkow, Muller,
  Pecevski, Perrinet, and Yger]{Davison2009}
D.~P. Andrew, D.~Br{\"{u}}derle, J.~Eppler, J.~Kremkow, E.~Muller, D.~Pecevski,
  L.~Perrinet, and P.~Yger.
